...
function sendMessage_Shark_UX_Signal(coinText){
	...
	if(coinText != undefined && coinText != "" && coinText != null ){
		var url = "https://api.telegram.org/" + botID +"/sendMessage?chat_id=" + Shark_UX_Signal + "&text=https://www.binance.com/trade.html?symbol=" + coinText.toUpperCase()+"_BTC" +"%0AMúc "; 
		var Httpreq = new XMLHttpRequest(); // a new request
		Httpreq.onreadystatechange = function() {
		    if (this.readyState == 4 && this.status == 200) {
...
function sendMessage_Shark_tank_home_signal(coinText){
	...
	if(coinText != undefined && coinText != "" && coinText != null ){
		...
		var url = "https://api.telegram.org/" + botID +"/sendMessage?chat_id=" + Shark_tank_home_signal + "&text=https://www.binance.com/trade.html?symbol=" + coinText.toUpperCase()+"_BTC"+"%0AMúc "; 
		var Httpreq = new XMLHttpRequest(); // a new request
		Httpreq.onreadystatechange = function() {
		    if (this.readyState == 4 && this.status == 200) {
...
function sendMessage_Shark_tank_JP_Signal(coinText){
	//https://api.telegram.org/botID/sendMessage?chat_id=groupID&text=test
	if(coinText != undefined && coinText != "" && coinText != null ){
		var url = "https://api.telegram.org/" + botID +"/sendMessage?chat_id=" + Shark_tank_JP_Signal + "&text=https://www.binance.com/trade.html?symbol=" + coinText.toUpperCase()+"_BTC" +"%0AMúc "; 
		var Httpreq = new XMLHttpRequest(); // a new request
		Httpreq.onreadystatechange = function() {
		    if (this.readyState == 4 && this.status == 200) {
...
function sendMessage_Shark_Tank_FU_Signal(coinText){
	//https://api.telegram.org/botID/sendMessage?chat_id=groupID&text=test
	if(coinText != undefined && coinText != "" && coinText != null ){
		var url = "https://api.telegram.org/" + botID +"/sendMessage?chat_id=" + Shark_Tank_FU_Signal + "&text=https://www.binance.com/trade.html?symbol=" + coinText.toUpperCase()+ "_BTC" +"%0AMúc "; 
		var Httpreq = new XMLHttpRequest(); // a new request
		Httpreq.onreadystatechange = function() {
		    if (this.readyState == 4 && this.status == 200) {
